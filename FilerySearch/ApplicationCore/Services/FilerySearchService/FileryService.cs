...
namespace FilerySearch.ApplicationCore.Services.FilerySearchService
{
    /// <summary>
     ...
     /// </summary>
        ...
        /// <returns></returns>
        public static IEnumerable<FileProps> SearchOccurrences(string[] searchWords, DateTime fromDate, DateTime toDate, string directoryPath = null, bool mustMatchAllSearchWords = false, string fileType = ".csv", SearchOption searchOption = SearchOption.AllDirectories)
        {
        ...
        public int GetNumberOfFilesInRange(string directoryPath, DateTime fromDate, DateTime toDate, string fileType = ".csv", SearchOption searchOption = SearchOption.AllDirectories)
            ...
            private static IEnumerable<FileProps> FindAllOccurrences(List<string> searchWords, IEnumerable<FileProps> filesInRange, bool mustMatchAllSearchWords)
            {
